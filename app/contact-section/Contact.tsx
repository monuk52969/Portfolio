        ...
        <div className="mt-20 flex w-full flex-col items-end justify-center gap-16 sm:mt-32 sm:gap-12 md:mt-40 md:flex-row md:items-start md:justify-between lg:mt-12 lg:max-w-[1440px]">
          <div className=" flex w-[350px] max-w-[90%] flex-col items-end text-right text-[14px] font-semibold uppercase text-[#e4ded7] sm:w-[350px] sm:text-[14px] md:w-[310px] md:items-start md:text-left md:text-[16px] lg:w-[420px] lg:text-[16px]">
            ...
            <div className="bor der mt-5 flex w-[298px] items-center gap-1 md:w-[335px] md:gap-2.5">
              <Link
                href="mailto:monuk52069@gmail.com?subject=Lets%20work%20together!&amp;body=Hello%2C%20I%20think%20we%20need%20you%20to%20work%20on%2Fcollaborate%20this%20particular%20product...%20Reach%20out%20as%20soon%20as%20you%20can."
                target="_blank"
              ...
              />
              <Link
                href="https://cal.com/monu-kumar-ufsuwv/secret?overlayCalendar=true"
                target="_blank"
                aria-label="Send me an email"
          ...
          <div className="flex gap-10 text-[16px] font-bold text-[#e4ded7]  sm:gap-14 sm:text-[24px] md:gap-10 md:text-[16px] lg:gap-20 lg:text-[28px]">
            ...
            <Link
              href="https://www.linkedin.com/in/monu-kumar-a2b257220?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3Btdd%2FjSrOTfKW5ejoDtWguw%3D%3D"
              target="_blank"
            ...
            <Link
              href="https://www.instagram.com/markdev_services?igsh=MXB1ZTQzamFyZzUzdA=="
              target="_blank"
