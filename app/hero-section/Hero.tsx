...
const Hero = () => {
  return (
    ...
    >
      ...
      <div className="-mt-30 flex flex-col items-center justify-center sm:-mt-20 lg:my-40 lg:-mt-2 lg:py-40 ">
        <div
      ...
      >
        ...
        >
          <p className="z-50 text-center text-[16px] font-medium text-[#e4ded7] md:text-[20px] lg:text-left">
            Frontend Developer and Web Designer — available for freelance and collaborative {" "}
            <Link
              href="https://www.sheryians.com/"
              target="_blank"
              className="underline underline-offset-2 hover:no-underline"
              aria-label="Sheriyans coding school"
            >
              projects.
            </Link>{" "}
        ...
        >
          <p className="text-right text-[16px] font-semibold text-[#e4ded7] md:text-[20px]">
            Focused on interfaces and experiences, working remotely from Dehradun,
            India.
          </p>
        </motion.div>
      </div>
